...
try{
	...
	String sql = "select rank() over(order by stolen_base desc)||'위' as rk, playername, stolen_base from hittertbl where stolen_base not in(0) order by stolen_base desc";
