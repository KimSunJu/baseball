...
try{
	...
	String sql = "select rank() over(order by batting_average desc)||'위' as rk, playername, batting_average from hittertbl order by batting_average desc";
