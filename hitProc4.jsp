...
<caption>홈런 순위(0개 친 선수 제외)</caption>
<tr bgcolor=" #ffff99">
...
try{
	...
	String sql = "select rank() over(order by homerun desc)||'위' as rk, playername, homerun from hittertbl where homerun not in(0) order by homerun desc";
