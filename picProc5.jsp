...
try{
	...
	String sql = "select rank() over(order by saves desc)||'위' as rk, playername,saves from picthertbl  where saves not in(0) order by saves desc";
